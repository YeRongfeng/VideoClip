        ...
        try:
            ...
            while current_frame_num <= end_frame:
                ...
                try:
                    ...
                    # 空间裁切（如果启用）
                    if (crop_params and crop_params['width'] > 0 
                        and crop_params['height'] > 0):
                        
                        if (crop_params['x'] + crop_params['width'] <= frame.shape[1] 
                            ...
                            processed_frame = np.zeros(
                                (crop_params['height'], crop_params['width'], 3), 
                                dtype=np.uint8
                            )
...
class CallbackManager:
    ...
    def set_callbacks(self, progress_cb=None, complete_cb=None, 
                     error_cb=None, warning_cb=None):
        """设置回调函数"""
